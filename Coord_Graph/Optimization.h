...
public:
    ...
    {}
    virtual std::vector<double> Optimize(const std::vector<double>& x, std::vector<std::vector<double>>& path) = 0;
};
...
public:
    ...
    std::vector<double> Optimize(const std::vector<double>& x, std::vector<std::vector<double>>& path) override;
};
